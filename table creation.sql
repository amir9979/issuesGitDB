...
CREATE TABLE IF NOT EXISTS "MethodData" (
	"CommitID" 		VARCHAR(40) NOT NULL,
	"MethodName" 	VARCHAR(100) NOT NULL,
	"OldNew"		VARCHAR(4) NOT NULL,
	...
	--FOREIGN KEY("CommitID") REFERENCES "Commits"("CommitID") ON DELETE RESTRICT ON UPDATE RESTRICT,
	--FOREIGN KEY("MethodName") REFERENCES "CommitChanges"("MethodName") ON DELETE RESTRICT ON UPDATE RESTRICT
);
